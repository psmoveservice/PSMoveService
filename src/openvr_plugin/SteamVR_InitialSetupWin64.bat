...
del SteamVR_SetDriverVarsWin64.bat
echo @echo off >> SteamVR_SetDriverVarsWin64.bat
echo set INSTALL_DIR=%STEAMVR_RUNTIME_DIR%\drivers\psmove>> SteamVR_SetDriverVarsWin64.bat
echo set STEAMVR_RUNTIME_DIR=%STEAMVR_RUNTIME_DIR%>> SteamVR_SetDriverVarsWin64.bat

:: Copy over the openvr drivers
call SteamVR_ReinstallDriverWin64.bat
pause
goto exit
