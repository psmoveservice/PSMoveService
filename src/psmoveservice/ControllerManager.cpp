...
ControllerManager::update()
{
    ...
    if (update_diff.count() >= m_config->controller_update_interval)
    {
        update_controllers();
    ...
    std::chrono::duration<double> reconnect_diff = now - m_last_reconnect_time;
    if (reconnect_diff.count() >= m_config->controller_reconnect_interval)
    {
...
ControllerManager::getControllerView(int controller_id)
{
...
int
ControllerManager::getControllerViewCount() const
{
...
void
ControllerManager::update_controllers()
{
...
void
ControllerManager::update_connected_controllers()
{
...
void
ControllerManager::send_controller_list_changed_notification()
{
...
int
ControllerManager::find_open_controller_controller_id(const ControllerDeviceEnumerator &enumerator)
{
...
int
ControllerManager::find_first_closed_controller_controller_id()
{
    int result_controller_id= -1;
